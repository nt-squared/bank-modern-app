...
const Hero = () => {
  return (
    <section id="home" className="flex md:flex-row flex-col sm:py-16 py-6">
      <div className="flex-1 flex jus items-start flex-col xl:px-0 sm:px-16 px-6">
        <div className="flex items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className="font-poppins text-dim-white text-lg leading-[30.8px] ml-2">
        ...
        <p className="font-poppins text-dim-white text-lg leading-[30.8px] max-w-[470px] mt-5">
      ...
      <div className="flex-1 flex justify-center items-center md:my-0 my-10 relative">
        ...
        <div className="absolute z-[1] w-4/5 h-4/5 bottom-40 white__gradient rounded-full" />
